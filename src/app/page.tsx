            ...
            <article className={styles.caseRow} key={item.id}>
              <div className={styles.caseName}>
                ...
                <div>
                  ...
                  {item.incident_date && (
                    <small>
                      Incident: {formatPublicDate(item.incident_date)}
                    </small>
                  )}
                </div>
              </div>
            ...
            <div className={styles.recordSources}>
              ...
              <div className={styles.sourceRow}>
                ...
                <div className={styles.sourceCopy}>
                  ...
                  <span>
                    {preview.location ?? "Public case record"}
                  </span>
                </div>

                <small>
                  {preview.legal_status ?? "OPEN"}
                </small>
              </div>
              ...
              <div className={styles.sourceRow}>
                ...
                <div className={styles.sourceCopy}>
                  ...
                  <span>
                    {formatPublicDate(preview.public_date)}
                  </span>
                </div>
